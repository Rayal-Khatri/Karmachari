...
ALLOWED_HOSTS = ['0449-2400-1a00-b030-c540-b8a4-d977-8734-2681.ap.ngrok.io','localhost', '127.0.0.1']

CSRF_TRUSTED_ORIGINS = ['https://0449-2400-1a00-b030-c540-b8a4-d977-8734-2681.ap.ngrok.io','https://*.127.0.0.1']
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "mainapp.Events":"fa-solid fa-calendar",
        ...
        "mainapp.Schedule": "fas fa-hourglass-start",
